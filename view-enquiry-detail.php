...
if (strlen($_SESSION['remsuid']==0)) {
   ...
   if(isset($_POST['submit']))
  {
   ...
   tblenquiry set Remark='$remark',Status='$status'
    where ID='$cid'");
    if ($query) {
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="breadcrumbs-wrap">
                    ...
                    <h2 class="breadcrumb-title">Inquiry Detail</h2>
                </div>
...
<tr>
    <th>Remark :</th>
    <td>
    <textarea name="remark" placeholder="" rows="12" 
    cols="14" class="form-control" required="true"></textarea></td>
  </tr>

  <tr align="center">
    <td colspan="2"><button type="submit"
     name="submit" class="btn btn--primary"></i> Update</button></td>
  </tr>
  </form>
<?php } else { ?>
<tr>
  <td colspan="2" style="text-align: center; color:blue">
  <strong>Broker / Owner Remark</strong></td>
