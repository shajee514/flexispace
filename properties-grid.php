...
tblstate.StateName from tblproperty
 join tblcountry on tblcountry
 .ID=tblproperty.Country join 
 tblstate on tblstate.ID=tblproperty.State
...
<div class="inc-fleat-icon">
    <img src="assets/img/person.svg" width="13"
alt="" /></div><?php echo $row['Size'];?>
</div>
<div class="listing-card-info-icon">
<div class="inc-fleat-icon">
    <img src="assets/img/room.svg" width="13"
alt="" /></div><?php echo $row['Type'];?>
</div>
<div class="listing-card-info-icon">
<div class="inc-fleat-icon">
    <img src="assets/img/timer.svg" width="13"
